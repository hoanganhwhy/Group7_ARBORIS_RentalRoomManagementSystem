  ...
  return (
    <div className="space-y-10">
      ...
      <header className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-charcoal-900 tracking-tight">Tổng quan</h1>
          <p className="text-charcoal-400 mt-2 text-base">Theo dõi hoạt động quản lý phòng trọ của bạn</p>
        </div>
      </header>
